...
| **Storage**      | microSD card slot, optional eMMC module (8–64GB) |
...
* 40-pin, 3.3V logic-level compatible
* Supports I2C, SPI, UART, PWM, GPIO
* Compatible with Raspberry Pi HATs and peripherals

> See [Pinout Diagram](hardware-pinout.md) for detailed GPIO mapping
